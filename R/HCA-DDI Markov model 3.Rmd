...
v_p_pill_birth$preg_rate_by_age <- preg_rate_by_age$p_preg_age_pill * p_m_pill_birth
v_p_pill_inducedabortion$preg_rate_by_age <- preg_rate_by_age$p_preg_age_pill * p_m_pill_inducedabortion
v_p_pill_spontaneousabortion$preg_rate_by_age <- preg_rate_by_age$p_preg_age_pill * p_m_pill_spontaneousbaortion
v_p_pill_ectopicpregnancy$preg_rate_by_age <- preg_rate_by_age$p_preg_age_pill * p_m_pill_ectopicpregnancy
...
```{r}
# from Healthy
m_P_pill["Initial", "Initial" ] <- 1 - v_p_pill_birth[1] - v_p_pill_inducedabortion[1] - v_p_pill_spontaneousabortion[1] - v_p_pill_ectopicpregnancy[1] - p_vte_pill - p_mi_pill - p_stroke_pill - p_imb_pill 
m_P_pill["Initial", "Birth" ]    <- v_p_pill_birth[1]
m_P_pill["Initial", "Induced abortion" ]      <- v_p_pill_inducedabortion[1] 
m_P_pill["Initial", "Spontanous abortion" ]  <- v_p_pill_spontaneousabortion[1] 
m_P_pill["Initial", "Ectopic pregnancy" ]   <- v_p_pill_ectopicpregnancy[1] 
...
m_P_pill["Post-IMB", "Birth"]  = v_p_pill_birth[1]
m_P_pill["Post-IMB", "Induced abortion"]  = v_p_pill_inducedabortion[1] 
m_P_pill["Post-IMB", "Spontanous abortion"]  = v_p_pill_spontaneousabortion[1]
m_P_pill["Post-IMB", "Ectopic pregnancy"]  = v_p_pill_ectopicpregnancy[1]
m_P_pill["Post-IMB", "VTE" ]  = p_vte_pill
m_P_pill["Post-IMB", "MI" ]  = p_mi_pill
m_P_pill["Post-IMB", "Stroke" ]  = p_stroke_pill
m_P_pill["Post-IMB", "Post-IMB" ]  = 1 - v_p_pill_birth[1] - v_p_pill_inducedabortion[1] - v_p_pill_spontaneousabortion[1] - v_p_pill_ectopicpregnancy[1] - p_vte_pill - p_mi_pill - p_stroke_pill
